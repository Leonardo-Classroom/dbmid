		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarToggler">
		      <ul class="navbar-nav me-auto mb-0 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <a class="nav-link postloader active" href="/register">註冊</a>
		        </li>
						<li class="nav-item">
	    ...
	    <div class="row d-flex align-items-center onePageHeight">
	      ...
	      <div class="col-12 col-md-6 col-lg-5 font-black onePageHeightAndCenterVertically antiFlow">
					...
					<div class="bg-white rounded-30 p-3 bingShadow">
						...
						<h1 class="p-3 mb-2">註冊</h1>
						<form class="mb-0" action="" method="post">

		          <div class="row">
		            <div class="col-6 form-group pr-1 mb-1">
		              <input type="text" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" placeholder="姓名">                              
		            </div>
		            <div class="col-6 form-group pl-1 mb-1">      
		              <select class="form-control bg-grey ">
		                <option>男</option>
		                <option>女</option>
		                <option>其他</option>
		              </select>
		          ...
		          <div class="form-group mb-1" style="position:relative">              
		            <input type="password" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" placeholder="密碼（至少8字，且含數字及字母大小寫。）">            
		
		          </div>
		          <div class="form-group mb-4" style="">              
		            <input type="password" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" placeholder="密碼確認">
		          </div>
